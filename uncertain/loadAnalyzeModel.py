...
def certainRightAndWrong(valAndTrain):
    for type in ['train', 'val']:
        ...
        certainRightCat2 = certain[(dset(2) > 0.9) & (dset(0).str.contains("0.0,1.0"))]
        ...
        certainWrongCat1 = certain[(dset(1) < 0.1) & (dset(0).str.contains("1.0,0.0"))]
        ...
        certainWrongCat2 = certain[(dset(2) < 0.1) & (dset(0).str.contains("0.0,1.0"))]
