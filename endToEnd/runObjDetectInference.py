...
# output_dir_class0, output_dir_class1 are just the names of the classes, used for directories
# category threshold is how likely must a category be for it to be chosen
# output directories and their parents will be made if they don't exist
def runObjDetection(data_dir, model_input_location, output_dir_class0, output_dir_class1, output_dir_skip, categoryThreshold):
